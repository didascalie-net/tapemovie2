{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 200.0, 264.0, 647.0, 461.0 ],
		"bglocked" : 0,
		"defrect" : [ 200.0, 264.0, 647.0, 461.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 472.0, 37.0, 122.0, 17.0 ],
					"text" : "moduleinit #1"
				}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "int", "int", "", "" ],
									"patching_rect" : [ 50.0, 177.0, 320.0, 246.0 ],
									"planes" : [ "enabled", "enabled", "enabled", "enabled" ],
									"presentation_rect" : [ 453.0, 503.0, 320.0, 246.0 ],
									"rate_divider" : 1,
									"skip_dropped" : 0,
									"stream_clicks" : 1
								}
...
,
					"patching_rect" : [ 216.0, 185.0, 97.0, 17.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 12.0,
						"globalpatchername" : "",
						"fontface" : 0,
...
,
					"patching_rect" : [ 72.0, 75.0, 97.0, 17.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 12.0,
						"globalpatchername" : "",
						"fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 112.0, 273.0, 224.0, 17.0 ],
					"text" : "makeparam #1/xfade #1 f 0 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 216.0, 123.0, 192.0, 17.0 ],
					"text" : "makeparam #1/b #1 s _"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 72.0, 13.0, 192.0, 17.0 ],
					"text" : "makeparam #1/a #1 s _"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 141.0, 100.0, 257.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 197.0, 212.0, 29.0, 17.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.0, 113.0, 29.0, 17.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 216.0, 143.0, 80.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 216.0, 164.0, 44.0, 17.0 ],
					"text" : "receive"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 72.0, 34.0, 80.0, 17.0 ],
					"text" : "sprintf set %s/out"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 72.0, 55.0, 44.0, 17.0 ],
					"text" : "receive"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.0, 372.0, 130.0, 17.0 ],
					"text" : "s #1/out"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 112.0, 315.0, 30.0, 17.0 ],
					"text" : "!- 1."
				}
...
, 			{
				"box" : 				{
					"comment" : "vns stream in B",
					"id" : "obj-11",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 72.0, 216.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 112.0, 294.0, 47.0, 17.0 ],
					"text" : "line 0. 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 141.0, 129.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 105.0, 164.0, 31.0, 17.0 ],
					"text" : "== 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 184.0, 55.0, 15.0 ],
					"text" : "bypass $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 32.0, 336.0, 99.0, 17.0 ],
					"saved_object_attributes" : 					{
						"planes" : [ "enabled", "enabled", "enabled", "enabled" ],
						"skip_dropped" : 0,
						"downsize_buffers" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 372.0, 15.0, 15.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "vns stream in A",
					"id" : "obj-20",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 350.0, 273.0, 136.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 472.0, 61.0, 142.0, 67.0 ],
					"text" : ";\r#1/sw/init bang;\n#1/menusclear bang;\r#1/a/init bang;\n#1/b/init bang;\n#1/xfade/init bang;"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 252.0, 321.0, 346.0, 34.0 ],
					"text" : "variable recieves + v.dissolve"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 206.5, 251.0, 81.5, 251.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 114.5, 206.0, 41.5, 206.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 0 ],
					"hidden" : 0,
					"midpoints" : [ 62.5, 166.0, 41.5, 166.0 ],
					"source" : [ "obj-2", 0 ]
				}
