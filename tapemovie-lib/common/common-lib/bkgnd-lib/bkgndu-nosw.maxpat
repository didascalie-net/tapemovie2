{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 9.0, 116.0, 1406.0, 800.0 ],
		"bglocked" : 0,
		"defrect" : [ 9.0, 116.0, 1406.0, 800.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1223.0, 429.0, 32.0, 17.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1330.0, 343.0, 29.0, 15.0 ],
					"text" : "mov"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 400.0, 157.0, 718.0, 679.0 ],
						"bglocked" : 0,
						"defrect" : [ 400.0, 157.0, 718.0, 679.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 273.0, 322.0, 32.0, 17.0 ],
									"text" : "print"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 600.0, 132.0, 70.0, 15.0 ],
									"text" : "setcheck 165"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 585.0, 111.0, 49.0, 15.0 ],
									"text" : "setcheck"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 368.0, 162.0, 29.0, 15.0 ],
									"text" : "mov"
								}
