{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 61.0, 80.0, 1220.0, 665.0 ],
		"bglocked" : 0,
		"defrect" : [ 61.0, 80.0, 1220.0, 665.0 ],
...
,
					"patching_rect" : [ 207.0, 401.0, 60.0, 23.0 ],
...
,
					"patching_rect" : [ 205.0, 238.0, 60.0, 23.0 ],
					"saved_object_attributes" : 					{
						"default_fontname" : "Arial",
						"globalpatchername" : "",
						"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 38.0, 73.0, 20.0 ],
					"text" : "Send off",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 253.0, 0.0, 65.0, 34.0 ],
					"text" : "OSC",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 217.0, 451.0, 195.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.0, 432.0, 68.0, 17.0 ],
					"text" : "pvar printsend"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 126.0, 313.0, 210.0, 17.0 ],
					"text" : "varieditu /print #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.0, 294.0, 72.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 119.0, 377.0, 195.0, 17.0 ],
					"text" : "varieditu /sw #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 119.0, 358.0, 66.0, 17.0 ],
					"text" : "pvar sendsw"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 117.0, 218.0, 195.0, 17.0 ],
					"text" : "varieditu /sw #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 117.0, 199.0, 66.0, 17.0 ],
					"text" : "pvar receivsw"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 197.0, 5.0, 54.0, 21.0 ],
					"text" : "print off",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 6.0, 73.0, 20.0 ],
					"text" : "Receive off",
					"textcolor" : [ 0.0, 0.0, 0.0, 0.2 ],
					"texton" : "Receive on",
					"textoncolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 143.0, 526.0, 61.0, 20.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 197.0, 37.0, 54.0, 21.0 ],
					"text" : "print off",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 315.0, 30.0, 194.0, 33.0 ],
					"textcolor" : [ 0.2, 0.0, 0.0, 0.24 ],
					"varname" : "ip"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 143.0, 555.0, 284.0, 17.0 ],
					"text" : "varieditu /host #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.0, 505.0, 53.0, 17.0 ],
					"text" : "pvar ip"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 250.0, 36.0, 74.0, 23.0 ],
					"text" : "ip adress : ",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 140.0, 36.0, 53.0, 23.0 ],
					"textcolor" : [ 0.2, 0.0, 0.0, 0.24 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "port2"
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 36.0, 66.0, 23.0 ],
					"text" : "port UDP",
					"textcolor" : [ 0.0, 0.0, 0.870588, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 143.0, 479.0, 284.0, 17.0 ],
					"text" : "varieditu /port #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.0, 460.0, 53.0, 17.0 ],
					"text" : "pvar port2"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 140.0, 4.0, 54.0, 23.0 ],
					"textcolor" : [ 0.2, 0.0, 0.0, 0.24 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "port"
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 4.0, 74.0, 23.0 ],
					"text" : "port UDP : ",
					"textcolor" : [ 0.0, 0.0, 0.870588, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 205.0, 290.0, 195.0, 17.0 ],
					"text" : "varieditu /port #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.0, 271.0, 53.0, 17.0 ],
					"text" : "pvar port"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 1.0, 512.0, 62.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 214.5, 309.0, 202.0, 309.0, 202.0, 269.0, 214.5, 269.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"hidden" : 0,
					"midpoints" : [ 152.5, 579.0, 139.0, 579.0, 139.0, 503.0, 152.5, 503.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 126.5, 237.0, 116.0, 237.0, 116.0, 197.0, 126.5, 197.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 128.5, 396.0, 115.0, 396.0, 115.0, 356.0, 128.5, 356.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 226.5, 470.0, 213.0, 470.0, 213.0, 430.0, 226.5, 430.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 135.5, 332.0, 125.0, 332.0, 125.0, 292.0, 135.5, 292.0 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-79", 0 ],
					"hidden" : 0,
					"midpoints" : [ 152.5, 498.0, 139.0, 498.0, 139.0, 448.0, 152.5, 448.0 ],
					"source" : [ "obj-78", 0 ]
				}
