...
, 			{
				"box" : 				{
					...
					"text" : "creer un submodule fog, un submodule light et un submodule advanced afin de n'avoir les elements dans le temp store que si on veut des données complexes"
				}
