...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.5, 102.5, 28.0, 15.0 ],
					"text" : "set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 333.75, 64.5, 45.0, 17.0 ],
					"text" : "zl.slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 333.75, 23.5, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 333.75, 102.5, 58.0, 17.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 333.75, 128.5, 63.0, 17.0 ],
					"text" : "pvar address"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 448.0, 154.5, 61.0, 15.0 ],
					"text" : "255 255 255"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 431.0, 131.5, 121.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 431.0, 176.5, 59.5, 17.0 ],
					"text" : "bgcolor"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 431.0, 79.5, 52.0, 17.0 ],
					"text" : "pvar sw"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 431.0, 99.5, 75.0, 17.0 ],
					"text" : "variedit sw"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 364.75, 27.5, 201.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 303.0, 21.0, 15.0, 15.0 ],
					"varname" : "sw"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 440.5, 121.5, 427.0, 121.5, 427.0, 75.5, 440.5, 75.5 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 343.25, 59.5, 496.5, 59.5 ],
					"source" : [ "obj-7", 0 ]
				}
