{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 892.0, 44.0, 441.0, 506.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
		"bglocked" : 0,
		"defrect" : [ 892.0, 44.0, 441.0, 506.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 86.0, 16.0, 60.0, 45.0 ],
					"rightvalue" : 64,
					"topvalue" : 0,
					"varname" : "dispxy"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 146.0, 23.0, 32.0, 15.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "dispfx"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 146.0, 39.0, 32.0, 15.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "dispfy"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 176.0, 39.0, 19.0, 15.0 ],
					"text" : "/y"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 176.0, 23.0, 19.0, 15.0 ],
					"text" : "/x"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 36.0, 42.0, 32.0, 15.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "speedlim"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 30.0, 44.0, 15.0 ],
					"text" : "/speedlim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 36.0, 15.0, 32.0, 15.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "smoothtime"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 27.0, 2.0, 53.0, 15.0 ],
					"text" : "/smoothtime"
				}
