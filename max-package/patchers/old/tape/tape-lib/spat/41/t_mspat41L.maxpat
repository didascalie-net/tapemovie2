{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 226.0, 258.0, 699.0, 343.0 ],
		"bglocked" : 0,
		"defrect" : [ 226.0, 258.0, 699.0, 343.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 562.0, 111.0, 66.0, 15.0 ],
					"text" : "zl join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 562.0, 91.0, 54.0, 15.0 ],
					"text" : "sprintf %sL"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 562.0, 71.0, 66.0, 15.0 ],
					"text" : "zl slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 56.0, 228.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 562.0, 131.0, 53.0, 15.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 31.0, 114.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 8,
					"numoutlets" : 0,
					"patching_rect" : [ 42.0, 114.0, 288.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "mspat41 to central matrix"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 42.0, 31.0, 247.0, 15.0 ],
					"text" : "t_mspat41ctlrL #1 #2 #3"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"hidden" : 0,
					"midpoints" : [ 652.0, 66.0, 571.5, 66.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"hidden" : 0,
					"midpoints" : [ 571.5, 152.0, 553.0, 152.0, 553.0, 52.0, 324.5, 52.0 ],
					"source" : [ "obj-7", 0 ]
				}
