{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 284.0, 44.0, 870.0, 650.0 ],
		"bglocked" : 0,
		"defrect" : [ 284.0, 44.0, 870.0, 650.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 567.0, 239.0, 198.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 543.0, 271.0, 133.0, 17.0 ],
					"text" : "s #1/spat/init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 373.0, 295.0, 261.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 373.0, 338.0, 31.0, 17.0 ],
					"text" : "== 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 373.0, 377.0, 50.0, 17.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 373.0, 319.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 373.0, 358.0, 45.0, 15.0 ],
					"text" : "mute $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 131.0, 209.0, 311.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 106.0, 183.0, 395.0, 17.0 ],
					"text" : "makeparam #1/win #1 f -1 -1 #2 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 81.0, 158.0, 338.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 56.0, 132.0, 327.0, 17.0 ],
					"text" : "makeparam #1/trsp #1 i 0 -2400 2400 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 544.0, 552.0, 120.0, 22.0 ],
					"text" : ";\r#1/trsprand 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 552.0, 265.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 16.0, 558.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 33.0, 557.0, 212.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 544.0, 520.0, 113.0, 22.0 ],
					"text" : ";\r#1/fbrand 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 520.0, 251.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 16.0, 526.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 33.0, 525.0, 198.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 783.0, 469.0, 27.0, 17.0 ],
					"text" : "/ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 732.0, 511.0, 61.0, 17.0 ],
					"text" : "pack 0. 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 753.0, 489.0, 21.0, 17.0 ],
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 753.0, 469.0, 27.0, 17.0 ],
					"text" : "del"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 732.0, 532.0, 51.0, 17.0 ],
					"text" : "s #1/vol"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 732.0, 447.0, 61.0, 17.0 ],
					"text" : "unpack 0. 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 732.0, 424.0, 61.0, 17.0 ],
					"text" : "r #1/wave"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 567.0, 73.0, 270.0, 139.0 ],
					"text" : ";\r#1/sw/init bang;\r#1/delrand 0;\r#1/volrand 0;\r#1/waverand 0;\r#1/fbrand 0;\r#1/trsprand 0;\r#1/trsp/init bang;\r#1/win/init bang;\r#1/del/init bang;\r#1/fb/init bang;\r#1/vol/init bang;\r#1/delclear bang;\r"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 31.0, 251.0, 136.0, 15.0 ],
					"text" : "t_harmunit~ #1 #2"
				}
