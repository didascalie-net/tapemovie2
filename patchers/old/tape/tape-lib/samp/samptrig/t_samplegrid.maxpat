{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 49.0, 101.0, 765.0, 374.0 ],
		"bglocked" : 0,
		"defrect" : [ 49.0, 101.0, 765.0, 374.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 629.0, 102.0, 99.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 205.0, 154.0, 15.0 ],
					"text" : "3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 185.0, 62.0, 17.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 164.0, 117.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 278.0, 90.0, 941.0, 786.0 ],
						"bglocked" : 0,
						"defrect" : [ 278.0, 90.0, 941.0, 786.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 94.0, 109.0, 65.0, 27.0 ],
									"text" : "s #1/triggering"
								}
...
,
					"patching_rect" : [ 21.0, 172.0, 167.0, 27.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"fontface" : 0,
						"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 437.0, 69.0, 102.0, 15.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 239.0, 16.0, 33.0, 17.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 239.0, 30.0, 31.0, 31.0 ]
				}
...
,
					"patching_rect" : [ 239.0, 64.0, 93.0, 17.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"fontface" : 0,
						"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 274.0, 30.0, 111.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.0, 82.0, 122.0, 17.0 ],
					"text" : "r #1/regiontrig"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 47.0, 131.0, 96.0, 17.0 ],
					"text" : "s #1/play"
				}
...
,
					"patching_rect" : [ 47.0, 104.0, 80.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"fontface" : 0,
						"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 240.0, 119.0, 114.0, 17.0 ],
					"text" : "vari #1/mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 240.0, 100.0, 100.0, 17.0 ],
					"pattrmode" : 1,
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 551.0, 21.0, 94.0, 15.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 437.0, 42.0, 101.0, 15.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 561.0, 102.0, 64.0, 17.0 ],
					"text" : "r /tape/init"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 561.0, 129.0, 92.0, 17.0 ],
					"text" : "s #1/init"
				}
...
,
					"patching_rect" : [ 21.0, 276.0, 159.0, 27.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"fontface" : 0,
						"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 437.0, 164.0, 172.0, 129.0 ],
					"text" : ";\r#1/mode samples;\r#1/play/tosamp /smp4.1;\r#1/play/disconnect bang;\r#1/play/trsplo -0.25;\r#1/play/trsphi 0.25;\r#1/play/rounding 0.;\r#1/play/vel 127;\r#1/play/az 0;\r#1/play/azoffset 0;\r#1/play/dist 1.;\r#1/play/pres 0.98;\r"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 437.0, 142.0, 92.0, 17.0 ],
					"text" : "r #1/init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 437.0, 21.0, 88.0, 15.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
									...
									"patcher" : 									{
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 507.0, 37.0, 178.0, 87.0 ],
...
,
					"patching_rect" : [ 21.0, 240.0, 159.0, 27.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"fontface" : 0,
						"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 241.0, 145.0, 838.0, 704.0 ],
						"bglocked" : 0,
						"defrect" : [ 241.0, 145.0, 838.0, 704.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 101.0, 220.0, 99.0, 27.0 ],
...
, 											{
												"box" : 												{
													...
													"save" : [ "#N", "qlist", ";", "#X", "insert", "sampgrid1/00samp", "groupC", ";", ";" ],
													"text" : "qlist"
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-11", 1 ],
													"hidden" : 0,
													"midpoints" : [ 178.5, 217.0, 190.5, 217.0 ],
													"source" : [ "obj-8", 0 ]
												}
...
,
					"patching_rect" : [ 21.0, 30.0, 180.0, 27.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"fontface" : 0,
						"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 239.0, 87.0, 100.0, 17.0 ],
					"text" : "#1/mode"
				}
