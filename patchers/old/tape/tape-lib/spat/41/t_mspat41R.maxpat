{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 226.0, 258.0, 687.0, 332.0 ],
		"bglocked" : 0,
		"defrect" : [ 226.0, 258.0, 687.0, 332.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"comment" : "connections list",
					"id" : "obj-1",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 645.0, 48.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 562.0, 113.0, 66.0, 15.0 ],
					"text" : "zl join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 562.0, 93.0, 55.0, 15.0 ],
					"text" : "sprintf %sR"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 562.0, 73.0, 66.0, 15.0 ],
					"text" : "zl slice 1"
				}
...
,
					"patching_rect" : [ 315.0, 92.0, 120.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 57.0, 228.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 562.0, 133.0, 53.0, 15.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 562.0, 48.0, 78.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 518.0, 28.0, 54.0, 15.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 32.0, 114.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 8,
					"numoutlets" : 0,
					"patching_rect" : [ 42.0, 114.0, 287.0, 15.0 ],
					"text" : "t_tocentralmatrix41 #4"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 42.0, 31.0, 248.0, 15.0 ],
					"text" : "t_mspat41ctlrR #1 #2 #3"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"hidden" : 0,
					"midpoints" : [ 654.0, 68.0, 571.5, 68.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"hidden" : 0,
					"midpoints" : [ 571.5, 154.0, 553.0, 154.0, 553.0, 54.0, 324.5, 54.0 ],
					"source" : [ "obj-7", 0 ]
				}
