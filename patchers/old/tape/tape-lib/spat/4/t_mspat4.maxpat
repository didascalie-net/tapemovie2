{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 200.0, 44.0, 548.0, 296.0 ],
		"bglocked" : 0,
		"defrect" : [ 200.0, 44.0, 548.0, 296.0 ],
...
,
					"patching_rect" : [ 192.0, 74.0, 120.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 56.0, 228.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 437.0, 66.0, 53.0, 15.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.0, 166.0, 294.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 437.0, 46.0, 78.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 393.0, 26.0, 54.0, 15.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 31.0, 115.0, 15.0 ],
					"text" : "r #1/spat/init"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 7,
					"numoutlets" : 0,
					"patching_rect" : [ 42.0, 95.0, 160.0, 15.0 ],
					"text" : "t_tocentralmatrix4 #4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.0, 213.0, 101.0, 27.0 ],
					"text" : "mspat441"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.0, 196.0, 135.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 42.0, 31.0, 135.0, 15.0 ],
					"text" : "t_mspat4ctlr #1 #2 #3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.0, 117.0, 294.0, 42.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 209.0, 209.0, 107.0, 27.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 446.5, 90.0, 428.0, 90.0, 428.0, 52.0, 201.5, 52.0 ],
					"source" : [ "obj-3", 0 ]
				}
