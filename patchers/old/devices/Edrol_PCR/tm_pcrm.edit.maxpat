{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 302.0, 258.0, 830.0, 237.0 ],
		"bglocked" : 0,
		"defrect" : [ 302.0, 258.0, 830.0, 237.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 381.0, 32.0, 100.0, 17.0 ],
					"text" : "Edirol PCR-M30/80",
...
, 			{
				"box" : 				{
					"args" : [ "#1/display", "edirol PCR-M30/80 display/simul", 115 ],
					"id" : "obj-2",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
