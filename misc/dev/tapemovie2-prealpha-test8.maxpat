...
, 							{
								"box" : 								{
									...
									"fontsize" : 10.0,
									"id" : "obj-75",
									"items" : [ "controller", ",", "x", ",", "y", ",", "deltax", ",", "deltay", ",", "button", ",", "x", ",", "y", ",", "deltax", ",", "deltay", ",", "button" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
,
					"patching_rect" : [ 82.5, 58.459656, 47.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 10.0,
