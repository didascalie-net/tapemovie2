...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 21.0, 28.0, 138.0, 17.0 ],
					"text" : "receive~ #1/in~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 263.0, 135.0, 145.0, 17.0 ],
					"text" : "send #1R/out~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 170.0, 107.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 21.0, 55.0, 261.0, 17.0 ],
					"text" : "poly~ t_mng_ 1 args #1 32653.060547"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 135.0, 144.0, 17.0 ],
					"text" : "send #1L/out~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 1.0, 132.0, 28.0 ],
					"text" : "arg 1 : module prefix name;\rarg2 : max delay"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "t_mng_.maxpat",
				"bootpath" : "/there/projects1/SON_VID-environment/TAPE-MOVIE/tapemovie-public/trunk/tapemovie-lib/tape/tape-lib/mng",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
