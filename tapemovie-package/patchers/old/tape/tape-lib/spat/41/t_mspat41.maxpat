{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 31.0, 168.0, 673.0, 325.0 ],
		"bglocked" : 0,
		"defrect" : [ 31.0, 168.0, 673.0, 325.0 ],
...
,
					"patching_rect" : [ 315.0, 90.0, 120.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 560.0, 71.0, 53.0, 15.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 560.0, 46.0, 78.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 516.0, 26.0, 54.0, 15.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 42.0, 31.0, 244.0, 15.0 ],
					"text" : "t_mspat41ctlr #1 #2 #3"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 569.5, 90.0, 551.0, 90.0, 551.0, 52.0, 324.5, 52.0 ],
					"source" : [ "obj-3", 0 ]
				}
