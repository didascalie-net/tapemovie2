...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 204.0, 438.0, 32.5, 17.0 ],
					"text" : "t s b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 204.0, 476.0, 76.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 204.0, 417.0, 63.0, 17.0 ],
					"text" : "route replace"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 72.0, 504.0, 186.0, 17.0 ],
					"text" : "s #1/resetloops"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 204.0, 395.0, 87.0, 17.0 ],
					"text" : "r #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 724.0, 418.0, 34.0, 15.0 ],
					"text" : "5000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 467.0, 560.0, 83.0, 15.0 ],
					"text" : "set #1/buffer 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 467.0, 578.0, 96.0, 17.0 ],
					"text" : "s #1/wfR"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 180.0, 775.0, 34.0, 15.0 ],
					"text" : "out~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 28.0, 776.0, 52.0, 17.0 ],
					"text" : "*~ 0.707"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 45.0, 694.0, 30.0, 15.0 ],
					"text" : "in~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 797.0, 145.0, 17.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 50.0, 296.0, 253.0 ],
									"text" : "#1/sw/init bang;\r#1/replace/init bang;\r#1/replacesamp/init bang;\r#1/loop/init bang;\r#1/looplo/init bang;\r#1/loophi/init bang;\r#1/samplevel/init bang;\r#1/play/init bang;\r#1/testsw/init bang;\r#1/tonelevel/init bang;\r#1/tonefreq/init bang;\r#1/noiselevel/init bang;\r#1/pulsesw/init bang;\r#1/pulseperiod/init bang;\r#1/pulsewidth/init bang;\r#1/speed/init bang;\r#1/rec/init bang;\r#1/vol/init bang;\r#1/soundfilesmenu/update bang;\r#1/samplesmenu/update bang;\r// no longer need to send to module_register. happens in build.;\r// module_register #1;\r1;\r#1/resetloops bang;\r"
								}
...
,
					"patching_rect" : [ 1040.0, 540.0, 63.0, 17.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"default_fontface" : 0,
						"fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 978.0, 540.0, 40.0, 17.0 ],
					"save" : [ "#N", "qlist", ";", "#X", "insert", "/src2.1/sw/init", "bang", ";", ";", "#X", "insert", "/src2.1/replace/init", "bang", ";", ";", "#X", "insert", "/src2.1/replacesamp/init", "bang", ";", ";", "#X", "insert", "/src2.1/loop/init", "bang", ";", ";", "#X", "insert", "/src2.1/looplo/init", "bang", ";", ";", "#X", "insert", "/src2.1/loophi/init", "bang", ";", ";", "#X", "insert", "/src2.1/samplevel/init", "bang", ";", ";", "#X", "insert", "/src2.1/play/init", "bang", ";", ";", "#X", "insert", "/src2.1/testsw/init", "bang", ";", ";", "#X", "insert", "/src2.1/tonelevel/init", "bang", ";", ";", "#X", "insert", "/src2.1/tonefreq/init", "bang", ";", ";", "#X", "insert", "/src2.1/noiselevel/init", "bang", ";", ";", "#X", "insert", "/src2.1/pulsesw/init", "bang", ";", ";", "#X", "insert", "/src2.1/pulseperiod/init", "bang", ";", ";", "#X", "insert", "/src2.1/pulsewidth/init", "bang", ";", ";", "#X", "insert", "/src2.1/speed/init", "bang", ";", ";", "#X", "insert", "/src2.1/rec/init", "bang", ";", ";", "#X", "insert", "/src2.1/vol/init", "bang", ";", ";", "#X", "insert", "/src2.1/soundfilesmenu/update", "bang", ";", ";", "#X", "insert", "/src2.1/samplesmenu/update", "bang", ";", ";", "#X", "insert", "//", "no", "longer", "need", "to", "send", "to", "module_register.", "happens", "in", "build.", ";", ";", "#X", "insert", "//", "module_register", "/src2.1", ";", ";", "#X", "insert", 1, ";", ";", "#X", "insert", "/src2.1/resetloops", "bang", ";", ";" ],
					"text" : "qlist"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 938.0, 696.0, 132.0, 17.0 ],
					"text" : "s #1/loophi"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 918.0, 716.0, 132.0, 17.0 ],
					"text" : "s #1/looplo"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 898.0, 669.0, 50.0, 17.0 ],
					"text" : "t 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 898.0, 629.0, 165.0, 17.0 ],
					"text" : "r #1/resetloops"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 898.0, 650.0, 15.0, 15.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "int" ],
									"patching_rect" : [ 132.0, 200.0, 210.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "int" ],
									"patching_rect" : [ 23.0, 104.0, 187.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 591.0, 413.0, 64.0, 17.0 ],
					"text" : "r #1/write"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 270.0, 538.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 714.0, 488.0, 96.0, 17.0 ],
					"text" : "prepend size"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 707.0, 452.0, 85.0, 17.0 ],
					"text" : "r #1/size"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 584.0, 751.0, 69.0, 17.0 ],
					"text" : "s #1/loophi"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 561.0, 772.0, 69.0, 17.0 ],
					"text" : "s #1/looplo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 11.0, 694.0, 30.0, 15.0 ],
					"text" : "in~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 952.0, 593.0, 195.0, 17.0 ],
					"text" : "s #1/spat/init"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 978.0, 467.0, 136.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 978.0, 495.0, 127.0, 17.0 ],
					"text" : "moduleinit #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 259.0, 607.0, 283.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 217.0, 334.0, 264.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 230.0, 357.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 143.0, 356.0, 84.0, 17.0 ],
					"text" : "t_gain2~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 231.0, 699.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 143.0, 698.0, 84.0, 17.0 ],
					"text" : "t_vol2~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 217.0, 676.0, 273.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 143.0, 775.0, 33.0, 15.0 ],
					"text" : "out~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 497.0, 536.0, 50.0, 17.0 ],
					"text" : "del 5000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 497.0, 516.0, 50.0, 17.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 367.0, 560.0, 83.0, 15.0 ],
					"text" : "set #1/buffer 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 327.0, 521.0, 160.0, 17.0 ],
					"text" : "buffer~ #1/buffer -1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 481.0, 292.0, 64.0, 17.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 259.0, 628.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 259.0, 647.0, 51.0, 17.0 ],
					"text" : "selector~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 143.0, 676.0, 27.0, 17.0 ],
					"text" : "+~"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 391.5, 315.0, 185.0, 315.0 ],
					"source" : [ "obj-122", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 300.5, 303.0, 152.5, 303.0 ],
					"source" : [ "obj-122", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 268.5, 668.0, 160.5, 668.0 ],
					"source" : [ "obj-137", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 268.5, 668.0, 197.5, 668.0 ],
					"source" : [ "obj-137", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 318.5, 547.0, 476.5, 547.0 ],
					"source" : [ "obj-90", 0 ]
				}
