...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 27.0, 104.0, 73.0, 17.0 ],
					"text" : "t_sf8to4edit_"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 33.0, 116.0, 17.0 ],
					"text" : "r /sf8to4/editor/close"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "t_sf8to4edit_.mxt",
				"bootpath" : "/there/projects1/SON_VID-environment/TAPE-MOVIE/tapemovie-public/trunk/tapemovie-lib/tape/tape-lib/sf/sf8to4",
				"patcherrelativepath" : "",
				"type" : "TEXT",
				"implicit" : 1
			}
