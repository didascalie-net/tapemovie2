{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 374.0, 274.0, 648.0, 235.0 ],
		"bglocked" : 0,
		"defrect" : [ 374.0, 274.0, 648.0, 235.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 93.0, 202.0, 42.0 ],
					"text" : "arg 1 : activeparams prefix name (i.e. t_snapshot);\rarg 2 : switch coll name (i.e. switchstate);\rarg 3 : matrix prefix name;\rarg 4 : coll matrix name;\r"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 5,
					"numoutlets" : 0,
					"patching_rect" : [ 236.0, 56.0, 325.0, 17.0 ],
